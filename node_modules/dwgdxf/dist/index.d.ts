 ...
 */
export declare function convertDwgToDxf(dwg: Uint8Array | ArrayBuffer, options?: ConvertOptions): Promise<Uint8Array>;
/**
 ...
 * @param options  Optional configuration (e.g. a custom `wasmBase` URL).
 */
export declare function init(options?: ConvertOptions): Promise<void>;
